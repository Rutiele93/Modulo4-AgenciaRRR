...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-A3rJD856KowSb7dwlZdYEkO39Gagi7vIsF0jrRAoQmDKKtQBHUuLZ9AsSv4jD4Xa"
	crossorigin="anonymous"></script>
<title>Alteração do Cliente ${cliente.nomeCliente}</title>
</head>
<body>
<main class="bd-navbar"> 
					...
					<div class="offcanvas-body p-5 pt-0 p-lg-0">
						...
						<ul class="navbar-nav flex-row flex-wrap bd-navbar-nav ms-md-auto">
							...
							<a class="nav-link" href="./html/promocao.html" style="padding-right: 15px;"> 
								<img src="./img/promocao.png" width="30px">Promoções<a></li>
							<!-- Cadastro -->
							<li class="nav-item col-6 col-lg-auto"><a class="nav-link"
	...
	<div class="container">
		<h5>Alteração do Cliente ${cliente.nomeCliente}</h5>		
		<form action="./atualizar-cliente" class="form-control bd-navbar">
