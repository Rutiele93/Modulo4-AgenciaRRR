	...
	<main class="bd-navbar">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="card bd-navbar">
					<div class="card-header">
						<h3 class="text-center">Clientes cadastrado</h3>
					</div>
						...
						<tbody>
							<jstl:forEach items="${listaClientes}" var="cliente">
								<tr>
									...
									<td>${cliente.email}</td>
									<td><a
										href="editar-cliente?idCliente=${cliente.idCliente}"
										class="btn btn-success">Editar</a> <a
										href="excluir-cliente?idCliente=${cliente.idCliente}"
