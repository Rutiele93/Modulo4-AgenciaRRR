...
<title>Alteração do Destino ${destino.nomeDestino}</title>
</head>
<body class="container-fluid bd-navbar">
	<main class="bd-navbar">
		...
		<!-- CORPO -->
		<section class="py-2 ml-0 mr-0">
		<h3>Alteração do Destino ${destino.nomeDestino}</h3>
		<div class="card-body bd-navbar">
		<form action="./atualizar-destino" class="form-control bd-navbar">
			<input type="hidden" name="idDestino" value="${destino.idDestino}">
			<p>Nome Destino:</p>
			<p>
				<input type="text"  name="nomeDestino" value="${destino.nomeDestino}">
			</p>
			<p>Preço Unitario:</p>
			<p>
				<input type="text"  name="precoUnit" value="${destino.precoUnit}">
			</p>
			<p>Categoria:</p>
			<p>
				<input type="text"  name="categoriaDestino" value="${destino.categoriaDestino}">
			</p>
			<p>Condição</p>
			<p>
				<input type="text" name="condicao" value="${destino.condicao}">
			</p>
			<p>Quantidade Disponivel:</p>
			<p>
				<input type="text"  name="qtdDisponivel" value="${destino.qtdDisponivel}">
			</p>			

			<p>Hora Ida:</p>
			<p>
				<input type="text" name="horaIda" value="${destino.horaIda}">
			</p>
			<p>Hora Chegada:</p>
			<p>
				<input type="text" name="horaChegada" value="${destino.horaChegada}">
			</p>
